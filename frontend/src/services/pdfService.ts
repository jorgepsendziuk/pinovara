      ...
      <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        ...
        <div style="text-align: center; margin-bottom: 30px; border-bottom: 2px solid #006400; padding-bottom: 20px;">
          ...
          <div style="font-size: 16px; color: #666; margin-top: 5px;">
            Projeto Inovador em Gestão do PNRA
          </div>
        ...
        <div style="text-align: justify; margin-bottom: 40px;">
          <p style="margin-bottom: 20px;">
            A pessoa jurídica <strong>${organizacao.nome}</strong>, CNPJ: <strong>${organizacao.cnpj}</strong>,
            endereço: <strong>${organizacao.endereco}</strong>, neste ato representada por:
            <strong>${organizacao.representanteNome}</strong>, portador(a) de Carteira de Identidade nº:
            <strong>${organizacao.representanteRG}</strong>, e do CPF nº: <strong>${organizacao.representanteCPF}</strong>,
            residente e domiciliado(a): <strong>${organizacao.representanteEndereco}</strong>,
            Função: <strong>${organizacao.representanteFuncao}</strong> na qualidade de Empreendimento Coletivo,
            firma o presente Termo de Adesão, para fins de comprovação junto ao Instituto Nacional de Colonização
            e Reforma Agrária (INCRA) em parceria com a Universidade Federal da Bahia (UFBA) no âmbito do TED nº 50/2023.
          </p>

          <p>
            Declara haver tomado prévio conhecimento em sua integridade sobre o PINOVARA, pelo que expressa plena
            concordância com as suas condições, princípios e orientações, comprometendo-se ainda a atender aos
            apontamentos técnicos e exigências legais realizadas pelas atividades que serão implementadas.
          </p>
        </div>

        <!-- Assinatura -->
        <div style="margin-top: 80px;">
          <div style="border-top: 1px solid #333; width: 70%; margin: 0 auto; padding-top: 20px; text-align: center;">
