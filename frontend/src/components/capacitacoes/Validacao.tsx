    ...
    <div className="validacao-container">
      <div className="page-header" style={{ marginBottom: '1rem', padding: '1rem 0' }}>
        <div className="page-header-left">
          ...
          <div>
            <h2 style={{ fontSize: '1.3rem', margin: 0 }}>Validação da Capacitação</h2>
      ...
      <div className="content-section">
        ...
        {!podeEditar && (
          <div className="alert alert-info" style={{ marginTop: '24px' }}>
            <AlertCircle size={18} />
            <span>A validação da capacitação é realizada por um coordenador através da lista de capacitações.</span>
          </div>
        )}
      </div>
    </div>
