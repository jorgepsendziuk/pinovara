...
('financeiro-orcamentario', 'Plano Financeiro e Orçamentário (Foco nos negócios)', 'Ampliar a autonomia financeira dos empreendedores', 'Diversificar as fontes de Receitas', 'Além da venda de produtos, considerar possibilidades de desenvolver atividades remuneradas associadas ao turismo de base comunitária, realização de oficinas etc.', 'Gestor do empreendimento', 'Facilitadores', 23, true),
('financeiro-orcamentario', 'Plano Financeiro e Orçamentário (Foco nos negócios)', 'Ampliar a autonomia financeira dos empreendedores', 'Qualificar as parcerias comerciais', 'Avaliar potenciais parceiros comerciais a partir dos critérios de comércio justo e solidário.', 'Gestor do empreendimento', 'Facilitadores', 24, true),
('financeiro-orcamentario', 'Plano Financeiro e Orçamentário (Foco nos negócios)', 'Ampliar a autonomia financeira dos empreendedores', 'Fortalecer a economia local e solidária', 'Priorizar a compra de insumos e matérias-primas de outros membros da comunidade, criando um sistema de ''moeda social'' ou crédito comunitário para incentivar o comércio interno', 'Gestor do empreendimento', 'Facilitadores', 25, true);
