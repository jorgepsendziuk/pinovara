...
exports.AREAS_GERENCIAIS = AREAS_GERENCIAIS;
function renderizarTodasAreasGerenciais(doc, organizacao) {
    AREAS_GERENCIAIS.forEach(area => {
        (0, renderizacaoPDF_1.renderizarCabecalhoArea)(doc, area.nome);
        area.subareas.forEach(subarea => {
            ...
            (0, renderizacaoPDF_1.renderizarTabelaPraticas)(doc, praticasComDados);
        });
    });
}
//# sourceMappingURL=areasGerenciaisHelper.js.map