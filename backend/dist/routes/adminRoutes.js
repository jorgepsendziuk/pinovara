...
router.get('/modules', adminController_1.default.getModules);
router.post('/modules', adminController_1.default.createModule);
router.put('/modules/:id', adminController_1.default.updateModule);
router.delete('/modules/:id', adminController_1.default.deleteModule);
router.get('/roles', adminController_1.default.getRoles);
router.get('/permissions/full', adminController_1.default.getPermissionsFull.bind(adminController_1.default));
