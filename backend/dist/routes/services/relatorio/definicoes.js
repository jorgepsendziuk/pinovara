"use strict";
/**
 * Definições completas de todas as 8 áreas gerenciais - 187 práticas
 * Formato: { n: número, t: título, c: prefixo do campo (sem _resposta/_comentario/_proposta) }
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.TODAS_AREAS = void 0;
exports.renderizarTodasAreasGerenciais = renderizarTodasAreasGerenciais;
const renderizacaoPDF_1 = require("./renderizacaoPDF");
exports.TODAS_AREAS = [
    // GO - GOVERNANÇA ORGANIZACIONAL (30 práticas)
    { nome: 'GOVERNANÇA ORGANIZACIONAL', sub: [
            { nome: 'Estrutura Organizacional', p: [
            ...
            { nome: 'Estratégia Organizacional', p: [
            ...
            { nome: 'Organização dos Associados', p: [
    ...
    { nome: 'GESTÃO DE PESSOAS', sub: [
            { nome: 'Organização das Pessoas no Trabalho', p: [
            ...
            { nome: 'Desenvolvimento das Pessoas no Trabalho', p: [
            ...
            { nome: 'Qualidade de Vida no Trabalho', p: [
    ...
    // GF - GESTÃO FINANCEIRA (26 práticas)
    { nome: 'GESTÃO FINANCEIRA', sub: [
            ...
            { nome: 'Controle de Contas a Receber e a Pagar', p: [
            ...
            { nome: 'Demonstração de Resultados', p: [
            ...
            { nome: 'Análise de Viabilidade Econômica', p: [
            ...
            { nome: 'Obrigações Fiscais Legais', p: [
    ...
    // GC - GESTÃO COMERCIAL (28 práticas)
    { nome: 'GESTÃO COMERCIAL', sub: [
            { nome: 'Estrutura Comercial', p: [
            ...
            { nome: 'Mercados Verdes, Sociais e Diferenciados', p: [
    ...
    { nome: 'GESTÃO DE PROCESSOS PRODUTIVOS', sub: [
            { nome: 'Regularidade Sanitária', p: [
            ...
            { nome: 'Logística da Produção e Beneficiamento', p: [
            ...
            { nome: 'Controle de Qualidade, Padronização e Rotulagem', p: [
            ...
            { nome: 'Bens de Produção', p: [
                    { n: 29, t: 'Os bens de produção estão atendendo as necessidades?', c: 'gpp_producao_29' }
                ] }
        ] },
    // GI - GESTÃO DA INOVAÇÃO (14 práticas)
    { nome: 'GESTÃO DA INOVAÇÃO', sub: [
            { nome: 'Adoção da Inovação, Informações e Conhecimento', p: [
            ...
            { nome: 'Monitoramento, Aprendizagem e Reconhecimento', p: [
            ...
            { nome: 'Equipes, Atores Relacionados e Tipos de Inovação', p: [
    ...
    // GS - GESTÃO SOCIOAMBIENTAL (22 práticas)
    { nome: 'GESTÃO SOCIOAMBIENTAL', sub: [
            { nome: 'Política Socioambiental', p: [
    ...
    // IS - INFRAESTRUTURA SUSTENTÁVEL (18 práticas)
    { nome: 'INFRAESTRUTURA SUSTENTÁVEL', sub: [
            { nome: 'Eficiência Energética', p: [
            ...
            { nome: 'Uso de Recursos Naturais', p: [
 ...
 */
function renderizarTodasAreasGerenciais(doc, org) {
    exports.TODAS_AREAS.forEach((area, index) => {
        // Nova página para cada área (como era antes)
        doc.addPage();
        doc.font('Helvetica-Bold').fontSize(14).fillColor('#056839')
            .text(`ÁREA GERENCIAL: ${area.nome}`, 50, 50);
        // Linha divisória
        doc.strokeColor('#056839').lineWidth(2)
            .moveTo(50, doc.y + 15)
            .lineTo(doc.page.width - 50, doc.y + 15)
            .stroke();
        doc.moveDown(1.5);
        // Renderizar subareas
        area.sub.forEach((subarea) => {
            // Renderizar subárea
            (0, renderizacaoPDF_1.renderizarSubarea)(doc, subarea.nome);
            // Montar práticas com dados
            const praticas = subarea.p.map((p) => ({
                numero: p.n,
                titulo: p.t,
            ...
            (0, renderizacaoPDF_1.renderizarTabelaPraticas)(doc, praticas);
        });
    });
}
