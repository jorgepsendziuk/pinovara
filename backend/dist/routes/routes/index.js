...
router.use('/', documentoRoutes_1.default); // Documento routes - usa /organizacoes/:id/documentos
...
router.use('/', assinaturaSyncRoutes_1.default); // Assinatura sync ODK routes - usa /organizacoes/:id/assinaturas/sync
