...
const fs = require('fs');
const { repositorioService } = require('../services/repositorioService');

// Pasta para arquivos do repositório público
const UPLOAD_DIR = '/var/pinovara/shared/uploads/repositorio';
...
const repositorioController = new RepositorioController();
