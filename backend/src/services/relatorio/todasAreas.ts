/**
 * Definições completas de todas as áreas gerenciais
 */
...
// === GESTÃO FINANCEIRA ===
export const GESTAO_FINANCEIRA: AreaGerencial = {
...
// Exportar tipagem para simplificar
export type OrganizacaoData = any; // TODO: criar interface completa
