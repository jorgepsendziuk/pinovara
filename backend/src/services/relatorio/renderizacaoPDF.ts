...
export const respostaMap: { [key: number]: string } = {
  1: 'Sim',
  2: 'Não',
  3: 'Parcial',
  4: 'Não se Aplica'
...
export const corRespostaMap: { [key: number]: string } = {
  1: '#056839',  // Verde
  2: '#d32f2f',  // Vermelho
  3: '#f57c00',  // Laranja
  4: '#666'      // Cinza
 ...
 */
export function renderizarCabecalhoArea(doc: any, nomeArea: string) {
  doc.addPage();
 ...
 */
export function renderizarSubarea(doc: any, titulo: string) {
 ...
 */
export function renderizarTabelaPraticas(doc: any, praticas: Array<{
  numero: number;
  titulo: string;
 ...
 */
export function renderizarAreaGerencial(
  doc: any, 
  nomeArea: string,
  subareas: Array<{
    nome: string;
