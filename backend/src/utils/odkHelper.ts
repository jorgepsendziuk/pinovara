 ...
 * // Retorna: "teste"
 */
export function extractEmailFromCreatorUri(creatorUri: string | null | undefined): string | null {
  if (!creatorUri) {
    return null;
  }
 ...
 */
export function isValidCreatorUri(creatorUri: string | null | undefined): boolean {
  if (!creatorUri) {
    return false;
  }
